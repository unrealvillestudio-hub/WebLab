...
import baseCssLight from './theme/assets/base-light.css?raw';
import themeJs from './theme/assets/theme.js?raw';
import themeLiquid from './theme/layout/theme.liquid?raw';
import themeLiquidLight from './theme/layout/theme-light.liquid?raw';
...
// ── LIGHT THEME — Neurone South & Central Florida ────────────────────────────
// Variante clara para uso alternativo o A/B
export const NEURONE_THEME_LIGHT_FILES: ThemeFile[] = [
  // Assets
  { key: 'assets/base.css',           value: baseCssLight,   description: 'CSS base — Light theme' },
  { key: 'assets/theme.js',           value: themeJs,        description: 'JavaScript del theme' },

  // Layout — light variant
  { key: 'layout/theme.liquid',       value: themeLiquidLight, description: 'Layout principal — Light' },

  // Config, Locales, Sections, Snippets, Templates — identicos al dark
  { key: 'config/settings_schema.json', value: settingsSchema, description: 'Schema de configuración' },
  { key: 'config/settings_data.json',   value: settingsData,   description: 'Datos de configuración' },
  { key: 'locales/es.default.json',   value: localesEs,        description: 'Textos en español' },
  { key: 'sections/nc-header.liquid',           value: ncHeader,          description: 'Header + Nav + Cart Drawer' },
...
export const THEME_LIGHT_NAME = 'Neurone South & Central Florida — Light v1.0';
export const THEME_LIGHT_FILE_COUNT = NEURONE_THEME_LIGHT_FILES.length;

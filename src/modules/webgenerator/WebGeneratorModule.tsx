...
const FIRMA_HTML = `<footer style="background:#0E1018;text-align:center;font-family:'DM Sans','Inter',system-ui,sans-serif;font-size:11px;letter-spacing:0.04em;color:#6B6460;padding:18px 24px 20px;margin-top:0;line-height:1.6;border-top:1px solid #1e1e2a;">Designed &amp; Developed by <a href="#" style="color:#C4622D;font-weight:600;text-decoration:none;">&gt;UNREALVILLE STUDIO</a><br><span style="font-size:10px;color:#6B6460;">12951 Biscayne Blvd, North Miami, FL 33181</span></footer>`;
